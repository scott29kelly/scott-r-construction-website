  ...
  return (
    <section className="bg-warm-black section-padding text-white">
      <div className="mx-auto max-w-site section-padding-x text-center">
        ...
        <h2 className="mx-auto max-w-content-2xl font-display text-section-heading">
          Remodeling, Additions, Decks & Patios — Crafted with {SITE_INFO.yearsExperience} Years of Hands-On Experience
        </h2>

        <p className="mx-auto mt-8 max-w-content-lg text-body-lg font-light leading-relaxed text-white/80">
